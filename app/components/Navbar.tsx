    ...
    <div className="navbar container inset-x-0 mx-auto px-5 sm:px-10 md:px-20 absolute invert z-20">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal font-bold uppercase px-1">
          <li>
            <a className="hover:bg-transparent hover:text-black">Products</a>
          </li>
          <li>
            <a className="hover:bg-transparent hover:text-black">
              Apps & Games
            </a>
          </li>
          <li>
            <a className="hover:bg-transparent hover:text-black">Features</a>
          </li>
          <li>
            <a className="hover:bg-transparent hover:text-black">Support</a>
          </li>
          <li>
            <a className="hover:bg-transparent hover:text-black">About</a>
          </li>
        </ul>
      </div>
